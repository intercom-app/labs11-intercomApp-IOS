...
class GroupController {
    ...
    let userEmail = LoginViewController().profileInfo?.email
    let userNikname = LoginViewController().profileInfo?.nickname
    
    
    func getUserInfo() {
        
        let baseURL = URL(string: "https://intercom-be.herokuapp.com/api/users")!
        
        //declare parameter as a dictionary which contains string as key and value combination. considering inputs are valid
        
        let parameters = ["email": userEmail, "displayName": userNikname]
